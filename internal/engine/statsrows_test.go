...
var statsLinesWant = map[string]string{
	"both-nil": ``,
	"empty-both": `СТАТИСТИКА — шагов применено 0/0 · пропущено 0 · ошибок 0 · перезагрузок 0
ПАКЕТЫ И ЯДРО:
ДИСК И ПАМЯТЬ:
БЕЗОПАСНОСТЬ:
  ...
  файрвол  нет
  fail2ban  нет`,
	"before-only": `СТАТИСТИКА — шагов применено 0/0 · пропущено 0 · ошибок 0 · перезагрузок 0
ПАКЕТЫ И ЯДРО:
  ядро  6.8.0-31
ДИСК И ПАМЯТЬ:
...
БЕЗОПАСНОСТЬ:
  ...
  файрвол  нет
  fail2ban  нет`,
	"after-only": `СТАТИСТИКА — шагов применено 0/0 · пропущено 0 · ошибок 0 · перезагрузок 0
ПАКЕТЫ И ЯДРО:
  ядро  6.8.0-45
ДИСК И ПАМЯТЬ:
...
БЕЗОПАСНОСТЬ:
  ...
  файрвол  нет → да
  fail2ban  нет → да`,
	"all-changed": `СТАТИСТИКА — шагов применено 1/4 · пропущено 2 · ошибок 1 · перезагрузок 1
ПАКЕТЫ И ЯДРО:
...
ПРИМЕНЁННЫЕ ФИКСЫ:
  ...
  [A9] Audit (FAIL)
  [A7] Purge (SKIP)`,
	"unchanged": `СТАТИСТИКА — шагов применено 0/0 · пропущено 0 · ошибок 0 · перезагрузок 0
ПАКЕТЫ И ЯДРО:
  ядро  6.8.0-31
ДИСК И ПАМЯТЬ:
  диск занято  2.9G/19.1G
...
БЕЗОПАСНОСТЬ:
  ...
  файрвол  нет
  fail2ban  нет`,
	"counts-and-zram": `СТАТИСТИКА — шагов применено 0/0 · пропущено 0 · ошибок 0 · перезагрузок 0
ПАКЕТЫ И ЯДРО:
  обновлено пакетов  5
  удалено пакетов  3
ДИСК И ПАМЯТЬ:
...
БЕЗОПАСНОСТЬ:
  ...
  файрвол  нет
  fail2ban  нет`,
	"zram-already-on": `СТАТИСТИКА — шагов применено 0/0 · пропущено 0 · ошибок 0 · перезагрузок 0
ПАКЕТЫ И ЯДРО:
ДИСК И ПАМЯТЬ:
БЕЗОПАСНОСТЬ:
  ssh только по ключу  нет
  файрвол  нет
  fail2ban  нет`,
	"net-partial-gw-only": `СТАТИСТИКА — шагов применено 0/0 · пропущено 0 · ошибок 0 · перезагрузок 0
ПАКЕТЫ И ЯДРО:
ДИСК И ПАМЯТЬ:
СЕТЬ:
  задержка ДЦ, ms  2.5
БЕЗОПАСНОСТЬ:
  ...
  файрвол  нет
  fail2ban  нет`,
	"net-partial-speed-only": `СТАТИСТИКА — шагов применено 0/0 · пропущено 0 · ошибок 0 · перезагрузок 0
ПАКЕТЫ И ЯДРО:
ДИСК И ПАМЯТЬ:
СЕТЬ:
...
БЕЗОПАСНОСТЬ:
  ...
  файрвол  нет
  fail2ban  нет`,
	"ports-before-only": `СТАТИСТИКА — шагов применено 0/0 · пропущено 0 · ошибок 0 · перезагрузок 0
ПАКЕТЫ И ЯДРО:
ДИСК И ПАМЯТЬ:
БЕЗОПАСНОСТЬ:
  открытых портов  2
  ...
  файрвол  нет
  fail2ban  нет`,
	"disk-total-missing": `СТАТИСТИКА — шагов применено 0/0 · пропущено 0 · ошибок 0 · перезагрузок 0
ПАКЕТЫ И ЯДРО:
ДИСК И ПАМЯТЬ:
